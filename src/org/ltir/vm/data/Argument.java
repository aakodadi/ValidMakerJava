...
public class Argument {
    ...
    /**
     * Regular expression to check for an IPv4 address
     */
    public static String IPV4_ADDR_REGEX = "^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$";
    /**
     * Regular expression to check for an IPv4 mask
     */
    public static String IPV4_MASK_REGEX = "((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}0";
    /**
     * Regular expression to check for a prefixed IPv4 address
     */
    ...
    /**
     * Regular expression to check for a prefixed IPv6 address
     */
    ...
    /**
     * Regular expression to check for an IPv6 address
     */
